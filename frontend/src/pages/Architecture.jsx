...
const principles = [
  {
    ...
    icon: '⚡',
    description:
      'Services exchange real-time events instantly, allowing the platform to scale efficiently across cloud workloads.',
  },
  {
    title: 'Microservices',
    icon: '🧩',
    description:
      'Every service handles a focused task, enabling faster deployments and easier scaling.',
  },
  {
    ...
    <div className="page-container">
      ...
      <section className="about-section">
        ...
        <div className="about-highlight">
          <p>
            AI continuously analyzes cloud activity, detects abnormal spending patterns, and generates intelligent recommendations to reduce infrastructure costs.
          </p>
